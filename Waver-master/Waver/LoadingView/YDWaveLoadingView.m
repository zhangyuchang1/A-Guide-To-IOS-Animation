...
//    return [[YDWaveLoadingView alloc] initWithFrame:CGRectMake(0, 0, 40, 31)];
    return [[YDWaveLoadingView alloc] initWithFrame:CGRectMake(0, 0, 320, 100)];
...
//    _grayImageView.image = [UIImage imageNamed:@"du.png"];
    _grayImageView.backgroundColor = [UIColor greenColor];
